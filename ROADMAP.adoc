...
| **`preservation`**
| 🟡 Admitted
| **12 open goals** after the reduction chain (PRs #92 / #102 / #104 / #106 / #114 / #116 / #117 / #121). Started at 910; 98.7% reduced. The original closure plan was superseded 2026-05-26 by a verified counterexample (`formal/Counterexample.v`); the canonical path forward is now the <<four-layer-redesign,Four-layer redesign>> above. Historical reduction notes preserved in `formal/PRESERVATION-HANDOFF.md`.
|===
