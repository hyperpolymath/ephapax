...
sessions of focused work). See also `docs/sessions/SESSION-2026-05-24-preservation-handoff.md`
...
| link:docs/specs/PROOF-NEEDS.md[docs/specs/PROOF-NEEDS.md]
| Outstanding proof obligations: what's `Admitted` / `covering` /
  `partial` and why.

| link:docs/sessions/SESSION-2026-05-24-preservation-handoff.md[docs/sessions/SESSION-2026-05-24-preservation-handoff.md]
...
| link:docs/specs/TOPOLOGY.md[docs/specs/TOPOLOGY.md]
| Module dependency graph + crate layering.

| link:docs/specs/TEST-NEEDS.md[docs/specs/TEST-NEEDS.md]
...
* link:CONTRIBUTING.md[CONTRIBUTING.md] — getting started
* link:CODE_OF_CONDUCT.md[CODE_OF_CONDUCT.md] — community standards

The highest-leverage open work, in priority order:

1. **Close `preservation` to Qed** (`docs/sessions/SESSION-2026-05-24-preservation-handoff.md`)
