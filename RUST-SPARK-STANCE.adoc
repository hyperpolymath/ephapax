...
`docs/specs/PROOF-NEEDS.md` and standards#134.
...
| Type-level statements of invariants E1–E6. **E2 head-form is
  ...
  Authoritative per-ID status: `docs/specs/PROOF-NEEDS.md` § Invariant register.
...
* `docs/specs/PROOF-NEEDS.md` (this repo) — invariant ledger and priorities
