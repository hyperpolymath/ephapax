...
| **`preservation`**
| 🟡 Admitted
| `formal/Semantics.v` (Theorem at line 3207). **12 open goals** as of 2026-05-21 (was 910). See ROADMAP §"Preservation closure plan" + `docs/sessions/SESSION-2026-05-24-preservation-handoff.md`.
|===
...
* `docs/vision/EPHAPAX-VISION.adoc` — design rationale, why dyadic +
  regions + WASM
* `docs/sessions/SESSION-2026-05-24-preservation-handoff.md` — per-case checklist for the 22
  remaining preservation goals
* `docs/specs/PROOF-NEEDS.md` — outstanding proof obligations + leverage
