...
image:https://github.com/hyperpolymath/ephapax/actions/workflows/smoke.yml/badge.svg?branch=main[Smoke,link="https://github.com/hyperpolymath/ephapax/actions/workflows/smoke.yml"]
